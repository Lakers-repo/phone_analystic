 ...
 * @since 1.0.0
 */
public class ActiveMemberUserOutputWriter implements IOutputWriter {
    private static final Logger logger = Logger.getLogger(ActiveMemberUserOutputWriter.class);
    @Override
